 ...
 */
public class ViewPagerPicAty extends YYDFBaseActivity implements PublicRequestInterface {


    private ViewPagerPicFrag viewPagerPicFrag;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.base_act_layout);
        viewPagerPicFrag = new ViewPagerPicFrag();
        FragmentTransaction transaction = getSupportFragmentManager()
                .beginTransaction();
        transaction.replace(R.id.base_act_content, viewPagerPicFrag);
        transaction.commit();
