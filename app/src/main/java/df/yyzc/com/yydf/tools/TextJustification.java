package df.yyzc.com.yydf.tools;//package com.alphaxp.yy.tools;
//
...
//					paint, contentWidth);
//			tempText = TextUtils.join(" ", lineList).replaceFirst("\\interfaces*", "");
//			resultText += tempText.replaceFirst("\\interfaces*", "") + "\n";
//		}
//
...
//			float contentWidth) {
//		String[] wordArray = text.split("\\interfaces");
