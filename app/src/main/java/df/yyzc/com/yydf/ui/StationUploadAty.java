 ...
 */
public class StationUploadAty extends YYDFBaseActivity implements PublicRequestInterface {


    private StationUploadFrag stationUploadFrag;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.base_act_layout);
        stationUploadFrag = new StationUploadFrag();
        FragmentTransaction transaction = getSupportFragmentManager()
                .beginTransaction();
        transaction.replace(R.id.base_act_content, stationUploadFrag);
        transaction.commit();
