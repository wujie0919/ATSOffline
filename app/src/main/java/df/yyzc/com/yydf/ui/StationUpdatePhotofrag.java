 ...
 */
public class StationUpdatePhotofrag extends YYDFBaseFragment implements View.OnClickListener, PublicRequestInterface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (contentView == null) {
            contentView = inflater.inflate(R.layout.frag_stationupdataphoto, null);
            ...
            title.setText(getActivity().getIntent().getStringExtra("stationname"));
...
//                imageVo.setStationId(stationVo.getStation_id());
                ...
                submitImage(imageVo, getActivity().getIntent().getStringExtra("stationId"));
                break;
        }
    }
                            ...
                            switch (tempUploadID) {
                                case 0:
                                    ...
                                    if (!TextUtils.isEmpty(uploadUrl) && uploadUrl.contains("oss")) {
                                        ImageLoader.getInstance().displayImage(uploadUrl.replace("oss", "img") + imageStyle, iamge0, YYOptions.Option_CARITEM);
                                    } else {
                                ...
                                case 1:
                                    ...
                                    if (!TextUtils.isEmpty(uploadUrl) && uploadUrl.contains("oss")) {
                                        ImageLoader.getInstance().displayImage(uploadUrl.replace("oss", "img") + imageStyle, iamge1, YYOptions.Option_CARITEM);
                                    } else {
                                ...
                                case 2:
                                    ...
                                    if (!TextUtils.isEmpty(uploadUrl) && uploadUrl.contains("oss")) {
                                        ImageLoader.getInstance().displayImage(uploadUrl.replace("oss", "img") + imageStyle, iamge2, YYOptions.Option_CARITEM);
                                    } else {
                                ...
                                case 3:
                                    ...
                                    if (!TextUtils.isEmpty(uploadUrl) && uploadUrl.contains("oss")) {
                                        ImageLoader.getInstance().displayImage(uploadUrl.replace("oss", "img") + imageStyle, iamge3, YYOptions.Option_CARITEM);
                                    } else {
                                ...
                                case 4:
                                    ...
                                    if (!TextUtils.isEmpty(uploadUrl) && uploadUrl.contains("oss")) {
                                        ImageLoader.getInstance().displayImage(uploadUrl.replace("oss", "img") + imageStyle, iamge4, YYOptions.Option_CARITEM);
                                    } else {
                                ...
                                case 5:
                                    ...
                                    if (!TextUtils.isEmpty(uploadUrl) && uploadUrl.contains("oss")) {
                                        ImageLoader.getInstance().displayImage(uploadUrl.replace("oss", "img") + imageStyle, iamge5, YYOptions.Option_CARITEM);
                                    } else {
    ...
    private void submitImage(StationUploadImageVo submitImage, String stationid) {

        if (submitImage != null) {
            RequestParams requestParams = new RequestParams();
            requestParams.addBodyParameter("mskey", YYConstans.getUser().getSkey());
            requestParams.addBodyParameter("groundUserId", YYConstans.getUser().getGround_user_id() + "");
            requestParams.addBodyParameter("stationId", stationid + "");
            requestParams.addBodyParameter("stationsImg", submitImage.toString());
            dialogShow();
            YYRunner.postData(1001, YYUrl.saveStationsImg, requestParams, this, true);
        }
    }
