...
public final class LruDiskCache implements Closeable {
     ...
     * constant string "libcore.io.DiskLruCache", the disk cache'interfaces version,
     * the application'interfaces version, the value count, and a blank line.
     *
     ...
     * its sequence number is not equal to its entry'interfaces sequence number.
     */
    ...
    public final class Snapshot implements Closeable {
        ...
        /**
         * Returns an editor for this snapshot'interfaces entry, or null if either the
    ...
    private final class Entry {
        ...
        /**
         * Lengths of this entry'interfaces files.
         */
        private final long[] lengths;
    ...
    private class StrictLineReader implements Closeable {
        ...
        public String readLine() throws IOException {
            synchronized (in) {
                ...
                // Though it'interfaces an error to read after an exception, we will let {@code fillBuf()}
                ...
                // Let'interfaces anticipate up to 80 characters on top of those already read.
