...
public interface IPullToRefresh<T extends View> {
     ...
     * user'interfaces touch gesture (i.e. scrolled to the top/bottom).
     *
     ...
     * LoadingLayout(interfaces) which will be affected, are chosen by the parameters you
     * give.
     * <p />
     * You should not keep the result of this method any longer than you need
     * it.
     ...
     * Android'interfaces standard Overscroll support (the edge-glow) which is available
     * from GINGERBREAD onwards
     *
     * @return true - if both PullToRefresh-OverScroll and Android'interfaces inbuilt
     ...
     * Android'interfaces standard Overscroll support (the edge-glow). This setting only
