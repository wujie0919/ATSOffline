...
public final class OverscrollHelper {
     ...
     * function.
     * <p/>
     * This should only be used on AdapterView'interfaces such as ListView as it just
     * calls through to overScrollBy() with the scrollRange = 0. AdapterView'interfaces
     ...
     * a Scroll Range but scroll back to it'interfaces edge correctly.
     *
     * @param view - PullToRefreshView that is calling this.
     * @param deltaX - Change in X in pixels, passed through from from
     *            overScrollBy call
     ...
     *            doesn't always scroll back to it'interfaces edge. 0 = no fuzziness.
